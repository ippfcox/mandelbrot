...
int main(int argc, char *argv[])
{
    ...
    double val_hor_min = -(double)pic_hor_max / 2 / ratio;
    double val_hor_max = (double)pic_hor_max / 2 / ratio;
    double val_ver_min = -(double)pic_ver_max / 2 / ratio;
    double val_ver_max = (double)pic_ver_max / 2 / ratio;
    ...
    for (int i = 0; i < pic_ver_max; ++i) // imag
    {
        ...
        {
            double z_real = ((val_hor_max - val_hor_min) / pic_hor_max) * j + val_hor_min;
            double z_imag = ((val_ver_max - val_ver_min) / pic_ver_max) * i + val_ver_min;
    ...
    stbi_write_png("julia.png", pic_hor_max, pic_ver_max, 3, data, pic_hor_max * 3);
}
